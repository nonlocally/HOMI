...
const TOOLS = [
  ...
  { name: "card_set", desc: "Self-describe on the bus: set an agent's card (what it is / what to ask it for). Cards beat chat titles in the roster's DESCRIPTION and survive resumes. Use name 'self' to describe this session.", schema: { name: z.string().describe("agent name, or 'self'"), what: z.string().optional(), ask_me_for: z.string().optional() }, argv: (a) => ["card", "set", a.name, ...(a.what ? ["--what", a.what] : []), ...(a.ask_me_for ? ["--ask-me-for", a.ask_me_for] : [])] },
];
